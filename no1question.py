...
df.to_csv('My_Cleaned_RewardsData.csv', index=False)

print("Data cleaning complete. Saved to My_Cleaned_RewardsData.csv")


# # Loading to data base

df = pd.read_csv('My_Cleaned_RewardsData.csv')
...
def main():
    ...
    csv_file_path = "My_Cleaned_RewardsData.csv"  # Replace with your CSV file path
